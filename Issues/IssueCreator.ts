...
import {IssueAppearance, OcotoBundle} from "../main";
...
export async function insertIssues(app: App, octobundle: OcotoBundle, arg: string | RepoItem, issue_appearance: IssueAppearance): Promise<void> {
	let issues: Issue[];
